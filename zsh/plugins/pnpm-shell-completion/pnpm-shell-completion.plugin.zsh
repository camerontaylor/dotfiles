...
# Vendored zsh glue for pnpm-shell-completion. The `pnpm-shell-completion`
# binary is installed via mise (github:g-plane/pnpm-shell-completion) and found
# on PATH below; only this completion shim lives in the repo now (previously a
# full Rust-source submodule). Upstream: https://github.com/g-plane/pnpm-shell-completion
