...
alias cc-ccr='(eval "$(ccr activate)" && CLAUDE_CODE_ATTRIBUTION_HEADER=0 exec claude)'
...
_cc-ccr()    { (eval "$(ccr activate)" && CLAUDE_CODE_ATTRIBUTION_HEADER=0 exec claude "$@") }
