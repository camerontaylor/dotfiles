---
name: find-docs
description: Look up library/framework docs and code examples via Context7. Use when verifying API signatures, checking usage patterns, or when training data may be outdated.
---
