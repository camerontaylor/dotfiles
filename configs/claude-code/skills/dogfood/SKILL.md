---
name: dogfood
description: Structured exploratory QA of a web app — produces a report with screenshots, repro videos, and severity-rated issues. Use when asked to dogfood, QA, bug-hunt, or exploratory-test a site.
