...
deploy_mkdir -p $XDG_CONFIG_HOME/{ghostty,cmux,git/local,htop,ranger,gem,tig,gnupg,nvim/{plugin,after},yazi,bat}
...
if [[ $ZDOTDIR == $SCRIPT_DIR/zsh ]]; then
    ...
    deploy_ln -sfn $SCRIPT_DIR/zsh/.zshenv ${ZDOTDIR:-$HOME}/.zshenv
fi
